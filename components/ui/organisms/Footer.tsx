...
<footer className="bg-[#C4FBDD] mt-20 p-4">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
        <div className="md:flex md:justify-between">
          ...
          />
              ...
              <div className="flex mt-6 space-x-6 sm:justify-start sm:mt-6">
              <Link href="#" className="text-[#00391B]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold  uppercase text-[#00391B]">Resources</h2>
                  <ul className="text-[#00391B] opacity-70 font-medium">
                      <li className="mb-4">
                          <Link href="" className="hover:underline">Example1</Link>
                      </li>
                      <li>
                          <Link href="" className="hover:underline">Example2</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold  uppercase text-[#00391B]">Follow us</h2>
                  <ul className=" text-[#00391B] opacity-70 font-medium">
                      <li className="mb-4">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold  uppercase text-[#00391B]">Legal</h2>
                  <ul className="text-[#00391B] opacity-70 font-medium">
                      <li className="mb-4">
