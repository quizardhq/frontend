...
export const faqs = [
  {
    id: 1,
    title: 'What is Quizard?',
    content: `Quizard is an exciting and interactive quiz game that allows you to play and create quizzes to challenge friends, colleagues or classmates in real-time during hangouts, tech festivals. Wherever there's a gathering, Quizard spices up the fun.`,
  },
  {
    id: 2,
    title: 'Why are you guys building Quizard?',
    content: `Well, we got tired of those other quiz platforms that kept trying to monetize our fun. It's like they didn't even care about our quizzes! So we put our tech skills to work and built Quizard, the quiz platform of our dreams. And the best part? It's open source, so you don't have to sell your firstborn to use it. We're pretty proud of ourselves, to be honest.`,
  },
  {
    id: 3,
    title: 'How does it work?',
    content: `Quizard is a multiplayer game, where one person creates and hosts the quiz, and others can join and play along in real-time. The host controls the pace of the game, asking questions and providing multiple choice answers. Players answer on their own devices and points are awarded for correct answers and speed.`,
  },
  {
    id: 4,
    title: 'What kind of quizzes can I create with Quizard?',
    content: `Quizard allows you to create quizzes on any topic you can imagine. Whether you want to test knowledge in a specific subject area or have fun with trivia, you can customize the game to your liking.`,
  },
  {
    id: 5,
    title: 'Is it free to use?',
    content: `Yes, hosting and taking fun quizzes on Quizard will always be free. That's the whole point of creating Quizard anyway. When we introduce paid packages, it'll be features you'll totally love to pay for.`,
  },
  {
    id: 6,
    title: 'How many players can participate?',
    content: `The number of players that can participate in a Quizard game is… Unlimited, just don't crash our servers 😉`,
  },
  {
    id: 7,
    title: 'Is it suitable for corporate events?',
    content: `Yes, Quizard is a great tool for corporate events, team-building exercises (think your next GDSC meetup and Techfests) or any other group activity. It allows you to engage participants and test their knowledge in a fun and interactive way.`,
  },
  {
    id: 8,
    title: 'How often does new features get added?',
    content: `Quizard is continuously being updated with new features and improvements based on user feedback. You can expect to see new features and updates on a regular basis.`,
  },
  {
    id: 9,
